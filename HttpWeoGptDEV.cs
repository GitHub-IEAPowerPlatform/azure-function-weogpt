...
public class HttpWeoGptDEV
{
    private readonly ILogger<HttpWeoGptDEV> _logger;
    private static readonly HttpClient httpClient = new HttpClient
    {
        Timeout = TimeSpan.FromSeconds(30)
    };

    public HttpWeoGptDEV(ILogger<HttpWeoGptDEV> logger)
    {
        _logger = logger;
    }
     //Azure Function URL: https://vscode-iea-weogpt-hmfbg4bha7fzc2bx.francecentral-01.azurewebsites.net/api/HttpWeoGptDEV?
    [Function("HttpWeoGptDEV")]
    public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get")] HttpRequestData req)
    {
        _logger.LogInformation("🔧 HttpWeoGptDEV function triggered.");
    ...
    private async Task<DirectLineTokenResponse?> FetchTokenAsync()
    {
        ...
        string tokenEndPoint = "https://54c679c972ae481a87ef70138e041d.e2.environment.api.powerplatform.com/powervirtualagents/botsbyschema/iea_weoGpt2024Advanced/directline/token?api-version=2022-03-01-preview";
